...
if mostrar_campos:
    ...
    # --- NOVO BLOCO ---
    # 🔀 Definição de Tratamento (Independente/Conjunto)
    ...
    # 🔀 Bloco de Isolamento entre Edificações (Novo código original)
    if len(todas_edificacoes) > 1:
    ...
    if len(todas_edificacoes) > 1:
        ...
        comentario_isolamento = st.text_area("Insira aqui suas observações sobre a análise de isolamento de risco.")
    # --- FIM NOVO BLOCO ---
